...
/**
 * Abstract class whose derived concrete instances are used by {@link it.sauronsoftware.jave.Encoder}
...
public abstract class FFMPEGLocator {
	...
	/**
	 * It returns a brand new {@link util.FFMPEGExecutor}, ready to be used in a
	 * ffmpeg call.
	 * 
	 * @return A newly instanced {@link util.FFMPEGExecutor}, using this locator to
